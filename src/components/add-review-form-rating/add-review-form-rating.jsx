...
export default function AddReviewFormRating({starsCount, defaultChecked, disabled}) {
  const stars = [];
  for (let i = 1; i <= starsCount; i++) {
    stars.push(<AddReviewFormStar key={i} id={i} checked={i === defaultChecked} disabled={disabled}/>);
  }
  stars.reverse();
